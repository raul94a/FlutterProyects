...
class MealsProvider with ChangeNotifier {
  ...
  void gluten(bool value) {
    _filters['gluten'] = value;
    notifyListeners();
  }

  void  lactose(bool value) {
    _filters['lactose'] = value;
    notifyListeners();
  }

  void vegetarian(bool value) {
    _filters['vegetarian'] = value;
    notifyListeners();
  }

  void  vegan(bool value) {
    _filters['vegan'] = value;
    notifyListeners();
  }

  void changeFilters(Map<String, bool> filters) {
    _filters = filters;
    notifyListeners();
  }

  List<Meal> get meals => [...DUMMY_MEALS];
  List<Meal> availableMeals(String categoryId) {
  ...
  List<Meal> get favoriteMeals =>
      DUMMY_MEALS.where((meal) => meal.isFav).toList();
